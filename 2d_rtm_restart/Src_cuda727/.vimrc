...
let mapleader = ","
let g:mapleader = ","
au BufNewFile,BufRead *.cu set ft=cuda  " 高亮.cu文件
...
let Tlist_Ctags_Cmd='/home/ganlin/local/bin/ctags'
...
call append(line(".")+1, "* Create : Lin ".strftime("%F"))
