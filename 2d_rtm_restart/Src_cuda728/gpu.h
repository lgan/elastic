...
#define index_ex(a,b) ((a+5)+(b)*(nz+10))     //an index transpose happens here
...
#define index3d_ex(a,b,c) ( (c)*(nx+10)*(nz+10) + (b)*(nz+10) + (a+5))     //an index transpose happens here, the expanded array
