...
{	
	...
	//fprintf(stderr,"TS=%d\n", g_it);
	rtm_gpu_kernel<<<dimGrid, dimBlock>>>(it,nt, nz, nx, g_Vx0, g_Vz0, g_sigmaxx0, g_sigmazz0, g_sigmaxz0, g_ex_m1_x, g_ex_m1_z, g_ex_aux_m2_c, g_ex_aux_m3_c, g_ex_aux_m2m3_c);
	cudaThreadSynchronize();

	rtm_gpu_kernelB<<<dimGrid, dimBlock>>>(it,nt, nz, nx, g_Vx0, g_Vz0, g_sigmaxx0, g_sigmazz0, g_sigmaxz0, g_ex_m1_x, g_ex_m1_z, g_ex_aux_m2_c, g_ex_aux_m3_c, g_ex_aux_m2m3_c);
	cudaThreadSynchronize();
	...
	//}
	fprintf(stderr, "Debugging here.\n");
	rtm_gpu_copy_out(nt, nz, nx, Vx0, Vz0, sigmaxx0, debug, sigmaxz0);	
	cudaThreadSynchronize();


     	rtm_gpu_copy_out_debug(nt, nz, nx, Vx0, Vz0, sigmaxx0, sigmazz0, sigmaxz0, ex_m1_x, ex_m1_z, ex_aux_m2_c, ex_aux_m3_c, ex_aux_m2m3_c);
