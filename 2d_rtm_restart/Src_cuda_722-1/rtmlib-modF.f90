...
interface
  ...
  subroutine rtm_op3_c(nt, nz, nx, zrec, Vx0, Vz0, sigmaxx0, sigmazz0, sigmaxz0, Vx, Vz, sigmaxx, sigmazz, sigmaxz, m1_x, m1_z,aux_m2_c, aux_m3_c, aux_m2m3_c) bind(c, name='rtm_op3_c_')
  import
