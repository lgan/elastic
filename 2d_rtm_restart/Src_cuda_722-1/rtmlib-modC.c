...
//    printf("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
//    printf( "#######Execyted frin C code in rtmlib-modC.c##########################\n");
...
// 
        for(ix=5-1; ix<nx-5; ix++)
            for(iz=5-1; iz<nz-5; iz++){
...
//      H_c(nz, nx, Vx0(:,:,it),sigmaxz0(:,:,(it+1)), aux_m3_c(:,:))
        ...
        for(ix=6-1; ix<nx-5 ; ix++)
            for(iz=6-1; iz<nz-5 ; iz++){
...
//    //char *str = "IBM";
//    //fprintf('%s',str);
//    //FILE * fp = fopen("dameit.txt","w");
//    printf("CCCCCC\n");
//    for(ix=6; ix<nx-5; ix++)
//        for(iz=5; iz<nz-5; iz++){
//          model[index(iz,ix+4)] = model[index(iz,ix+4)] + m1_x[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz,ix+3)] = model[index(iz,ix+3)] + m1_x[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix+2)] = model[index(iz,ix+2)] + m1_x[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix+1)] = model[index(iz,ix+1)] + m1_x[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix) ]  = model[index(iz,ix  )] + m1_x[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix-1)] = model[index(iz,ix-1)] - m1_x[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix-2)] = model[index(iz,ix-2)] - m1_x[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix-3)] = model[index(iz,ix-3)] - m1_x[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix-4)] = model[index(iz,ix-4)] - m1_x[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix-5)] = model[index(iz,ix-5)] - m1_x[index(iz,ix)]*c1*data[index(iz,ix)];
//        }
//
//}
//
...
//    for(ix=6; ix<nx-5; ix++)
//        for(iz=5; iz<nz-5; iz++){
//          model[index(iz+5,ix)] = model[index(iz+5,ix)] + m1_x[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz+4,ix)] = model[index(iz+4,ix)] + m1_x[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz+3,ix)] = model[index(iz+3,ix)] + m1_x[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz+2,ix)] = model[index(iz+2,ix)] + m1_x[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz+1,ix)] = model[index(iz+1,ix)] + m1_x[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz  ,ix)] = model[index(iz  ,ix)] - m1_x[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz-1,ix)] = model[index(iz-1,ix)] - m1_x[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz-2,ix)] = model[index(iz-2,ix)] - m1_x[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz-3,ix)] = model[index(iz-3,ix)] - m1_x[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz-4,ix)] = model[index(iz-4,ix)] - m1_x[index(iz,ix)]*c1*data[index(iz,ix)];
//       }
//
//}
//
...
//    for(ix=5; ix<nx-5; ix++)
//        for(iz=6; iz<nz-5; iz++){
//          model[index(iz,ix+5)] = model[index(iz,ix+5)] + m1_z[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz,ix+4)] = model[index(iz,ix+4)] + m1_z[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix+3)] = model[index(iz,ix+3)] + m1_z[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix+2)] = model[index(iz,ix+2)] + m1_z[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix+1)] = model[index(iz,ix+1)] + m1_z[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix  )] = model[index(iz,ix  )] - m1_z[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix-1)] = model[index(iz,ix-1)] - m1_z[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix-2)] = model[index(iz,ix-2)] - m1_z[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix-3)] = model[index(iz,ix-3)] - m1_z[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix-4)] = model[index(iz,ix-4)] - m1_z[index(iz,ix)]*c1*data[index(iz,ix)];
//      }
//
//}
//
...
//    for(ix=5; ix<nx-5; ix++)
//        for(iz=6; iz<nz-5; iz++){
//          model[index(iz+4,ix)] = model[index(iz+4,ix)] + m1_z[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz+3,ix)] = model[index(iz+3,ix)] + m1_z[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz+2,ix)] = model[index(iz+2,ix)] + m1_z[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz+1,ix)] = model[index(iz+1,ix)] + m1_z[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz  ,ix)] = model[index(iz  ,ix)] + m1_z[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz-1,ix)] = model[index(iz-1,ix)] - m1_z[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz-2,ix)] = model[index(iz-2,ix)] - m1_z[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz-3,ix)] = model[index(iz-3,ix)] - m1_z[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz-4,ix)] = model[index(iz-4,ix)] - m1_z[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz-5,ix)] = model[index(iz-5,ix)] - m1_z[index(iz,ix)]*c1*data[index(iz,ix)];
//      }
//
//}
//
...
//    for(ix=5; ix<nx-5; ix++)
//        for(iz=5; iz<nz-5; iz++){
//          model[index(iz,ix+5)] = model[index(iz,ix+5)] + aux_m2m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz,ix+4)] = model[index(iz,ix+4)] + aux_m2m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix+3)] = model[index(iz,ix+3)] + aux_m2m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix+2)] = model[index(iz,ix+2)] + aux_m2m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix+1)] = model[index(iz,ix+1)] + aux_m2m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix  )] = model[index(iz,ix  )] - aux_m2m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix-1)] = model[index(iz,ix-1)] - aux_m2m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix-2)] = model[index(iz,ix-2)] - aux_m2m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix-3)] = model[index(iz,ix-3)] - aux_m2m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix-4)] = model[index(iz,ix-4)] - aux_m2m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//     }
//
//}
//
...
//    for(ix=5; ix<nx-5; ix++)
//        for(iz=5; iz<nz-5; iz++){
//          model[index(iz+5,ix)] = model[index(iz+5,ix)] + aux_m2_c[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz+4,ix)] = model[index(iz+4,ix)] + aux_m2_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz+3,ix)] = model[index(iz+3,ix)] + aux_m2_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz+2,ix)] = model[index(iz+2,ix)] + aux_m2_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz+1,ix)] = model[index(iz+1,ix)] + aux_m2_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz  ,ix)] = model[index(iz  ,ix)] - aux_m2_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz-1,ix)] = model[index(iz-1,ix)] - aux_m2_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz-2,ix)] = model[index(iz-2,ix)] - aux_m2_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz-3,ix)] = model[index(iz-3,ix)] - aux_m2_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz-4,ix)] = model[index(iz-4,ix)] - aux_m2_c[index(iz,ix)]*c1*data[index(iz,ix)];
//     }
//
//}
//
...
//    for(ix=5; ix<nx-5; ix++)
//        for(iz=5; iz<nz-5; iz++){
//          model[index(iz,ix+5) ]= model[index(iz,ix+5) ]+ aux_m2_c[index(iz,ix) ]*c1*data[index(iz,ix)];
//          model[index(iz,ix+4)] = model[index(iz,ix+4)] + aux_m2_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix+3)] = model[index(iz,ix+3)] + aux_m2_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix+2)] = model[index(iz,ix+2)] + aux_m2_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix+1)] = model[index(iz,ix+1)] + aux_m2_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix  )] = model[index(iz,ix  )] - aux_m2_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix-1)] = model[index(iz,ix-1)] - aux_m2_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix-2)] = model[index(iz,ix-2)] - aux_m2_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix-3)] = model[index(iz,ix-3)] - aux_m2_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix-4)] = model[index(iz,ix-4)] - aux_m2_c[index(iz,ix)]*c1*data[index(iz,ix)];
//     }
//
//}
//
...
//    for(ix=5; ix<nx-5; ix++)
//        for(iz=5; iz<nz-5; iz++){
//          model[index(iz+5,ix)] = model[index(iz+5,ix)] + aux_m2m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz+4,ix)] = model[index(iz+4,ix)] + aux_m2m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz+3,ix)] = model[index(iz+3,ix)] + aux_m2m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz+2,ix)] = model[index(iz+2,ix)] + aux_m2m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz+1,ix)] = model[index(iz+1,ix)] + aux_m2m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz  ,ix)] = model[index(iz  ,ix)] - aux_m2m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz-1,ix)] = model[index(iz-1,ix)] - aux_m2m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz-2,ix)] = model[index(iz-2,ix)] - aux_m2m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz-3,ix)] = model[index(iz-3,ix)] - aux_m2m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz-4,ix)] = model[index(iz-4,ix)] - aux_m2m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//     
//        }
//}
//
...
//    for(ix=6; ix<nx-5; ix++)
//        for(iz=6; iz<nz-5; iz++){
//          model[index(iz+4,ix)] = model[index(iz+4,ix)] + aux_m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz+3,ix)] = model[index(iz+3,ix)] + aux_m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz+2,ix)] = model[index(iz+2,ix)] + aux_m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz+1,ix)] = model[index(iz+1,ix)] + aux_m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz  ,ix)] = model[index(iz  ,ix)] + aux_m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz-1,ix)] = model[index(iz-1,ix)] - aux_m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz-2,ix)] = model[index(iz-2,ix)] - aux_m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz-3,ix)] = model[index(iz-3,ix)] - aux_m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz-4,ix)] = model[index(iz-4,ix)] - aux_m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz-5,ix)] = model[index(iz-5,ix)] - aux_m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//     
//        }
//}
//
...
//    int ix, iz;
//    float c1=35.0/294912.0,c2=-405.0/229376.0,c3=567.0/40960.0,c4=-735.0/8192.0,c5=19845.0/16384.0;
//    //FILE * fp = fopen("111123.txt","w");
//    
//    for(ix=6; ix<nx-5; ix++)
//        for(iz=6; iz<nz-5; iz++){
//          model[index(iz,ix+4)] = model[index(iz,ix+4)] + aux_m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//          model[index(iz,ix+3)] = model[index(iz,ix+3)] + aux_m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix+2)] = model[index(iz,ix+2)] + aux_m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix+1)] = model[index(iz,ix+1)] + aux_m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix  )] = model[index(iz,ix  )] + aux_m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix-1)] = model[index(iz,ix-1)] - aux_m3_c[index(iz,ix)]*c5*data[index(iz,ix)];
//          model[index(iz,ix-2)] = model[index(iz,ix-2)] - aux_m3_c[index(iz,ix)]*c4*data[index(iz,ix)];
//          model[index(iz,ix-3)] = model[index(iz,ix-3)] - aux_m3_c[index(iz,ix)]*c3*data[index(iz,ix)];
//          model[index(iz,ix-4)] = model[index(iz,ix-4)] - aux_m3_c[index(iz,ix)]*c2*data[index(iz,ix)];
//          model[index(iz,ix-5)] = model[index(iz,ix-5)] - aux_m3_c[index(iz,ix)]*c1*data[index(iz,ix)];
//    
//        }
//}
