...
//	if(ix>=9 && ix<(nx-9)  &&  iz>=4 && iz<(nz-5)){
         ...
         g_Vx0[index3d(iz,ix  ,it)] = 0;
//         g_Vz0[index3d(iz,ix  ,it)] = 0;
//         g_sigmaxx0[index3d(iz,ix  ,it)] = 0;
//         g_sigmazz0[index3d(iz,ix  ,it)] = 0;
//         g_sigmaxz0[index3d(iz,ix  ,it)] = 0;
//


//g_Vx0[index3d(iz,ix  ,it)] +1;//	+ g_aux_m2m3_c[index(iz,ix-5)]*c1*g_sigmaxx0[index3d(iz,ix-5,it+1)];
